...
export const siteConfig = {
  ...
  currentFocus: "目前关注人工智能方向，同时持续补齐 Java 后端开发和工程实践能力。我希望自己既能理解模型，也能把想法做成真正可用的产品。",
  ...
  education: [
    { period: "2026 — 至今", title: "计算机相关专业 · 硕士研究生", detail: "研究方向探索、论文阅读与实验实践" },
    { period: "2022 — 2026", title: "本科阶段", detail: "软件开发基础、算法与项目实践" },
  ],

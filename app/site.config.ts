...
export const siteConfig = {
  ...
  initials: "Y",
  role: "计算机专业研究生",
  direction: "人工智能 · 医学图像 · 后端开发",
  intro: "把学习、研究和生活里的微小进步，认真地留在这里。",
  aboutIntro: "一名正在摸索研究方向的计算机专业研究生。喜欢把复杂问题慢慢拆开，也愿意记录那些暂时没有答案的时刻。",
  currentFocus: "目前关注人工智能与医学图像方向，同时持续补齐 Java 后端开发和工程实践能力。我希望自己既能理解模型，也能把想法做成真正可用的产品。",
  nextGoal: "完成一个扎实的研究课题，建立稳定的阅读与输出习惯，并让这个网站忠实记录一路上的变化。",
  ...
  education: [
    { period: "2025 — 至今", title: "计算机相关专业 · 硕士研究生", detail: "研究方向探索、论文阅读与实验实践" },
    { period: "2021 — 2025", title: "本科阶段", detail: "软件开发基础、算法与项目实践" },
  ],
